...
public class FdActivity extends Activity implements CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getDeviceName().contains("fc11501")) {
            mCameraFront = false;
            setContentView(org.opencv.samples.facedetect.R.layout.backcam_face_detect_surface_view);
        }
        else
            setContentView(org.opencv.samples.facedetect.R.layout.frontcam_face_detect_surface_view);
